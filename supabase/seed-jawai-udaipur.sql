...
insert into trips (
  ...
  'Escape 001 is built the wrong way round on purpose. Most Rajasthan trips start with the postcard and end somewhere quieter; this one starts in the quiet. You leave Delhi on a night train and wake up at Jawai Bandh, where the Aravallis have stopped being hills and turned into enormous bare granite domes sitting straight out of the ground. Breakfast is slow and nothing is scheduled until you have actually looked at the place. Then you meet it properly — time with a Rabari shepherd family in the country they have herded for generations, and an afternoon out in an open jeep with a naturalist who can tell you which family of leopards is denning where. Around fifty of them live on these rocks, directly above villages that have never hunted one. We are not going to promise you a sighting. The sighting is never promised. The experience is. Day two is deliberately unhurried: the dam and the crocodiles on its bank in the morning, the cave temple at Devgiri where the priests and the leopards have an arrangement nobody has written down, and then an afternoon with nothing in it at all, because an escape should not feel like work. Both evenings end around a table and a fire, with a question — what made you say yes to this journey, and later, what surprised you most about this place. On the last morning the trip changes character completely. Three hours east and Rajasthan turns from granite into water: Udaipur''s old city on foot, lunch somewhere a local would actually eat, an hour of your own, and the lake at last light with the phones away. Dinner is the whole group at one table, then everybody writes a letter to somebody they met four days ago and hands it over. You leave on the overnight coach still talking, and you get into Delhi on Tuesday morning having spent two days of leave.',
