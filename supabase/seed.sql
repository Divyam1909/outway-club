...
-- Escape 001: Udaipur × Mount Abu, 15–17 August.
--
...
-- ---------------------------------------------------------------------------
-- Destination — Udaipur (Escape 001 runs Udaipur → Mount Abu → Udaipur)
-- ---------------------------------------------------------------------------
...
('11111111-1111-1111-1111-111111111001', 'udaipur', 'Udaipur', 'Rajasthan', 'India',
  ...
  'July – March, with August the greenest',
...
('22222222-2222-2222-2222-222222222001', 2,
  ...
  '["Scenic monsoon drive through the Aravalli range","Dilwara Jain Temples — 11th–13th century marble carving","Nakki Lake and the Toad Rock walk","Sunset from Honeymoon Point","Bonfire evening and dinner at the resort"]',
